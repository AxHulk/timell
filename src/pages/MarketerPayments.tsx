...
import {
  ...
  Share2, FileEdit, BarChart3, MousePointerClick, LineChart, Palette, Video, Megaphone
} from "lucide-react";

const features = [
  { icon: ClipboardList, title: "Работа через задания", desc: "Помогаем выстроить работу с маркетологами от публикации заданий до расчёта по ним. Система отслеживает прогресс." },
  { icon: ShieldCheck, title: "Безопасные платежи", desc: "Автоматическая проверка налогового статуса и функционал «Чёрного списка» для минимизации рисков." },
  { icon: Users, title: "Работа с ИП", desc: "Выплаты не только самозанятым, но и ИП. А также оплата услуг по договорам ГПХ физлицам." },
  { icon: Receipt, title: "Оплата НПД", desc: "Как партнёр ФНС, платформа автоматически оплачивает НПД от лица исполнителя с учётом налогового бонуса." },
  { icon: PenTool, title: "ЭДО и ЭЦП", desc: "Все документы подписываются дистанционно с помощью простой электронной подписи." },
  { icon: Headphones, title: "Бесплатный консалтинг", desc: "Расскажем, как безопасно настроить бизнес-процессы при взаимодействии с внештатным персоналом." },
];

const steps = [
  { num: 1, title: "Регистрация", desc: "Маркетолог создает аккаунт, указывает реквизиты и налоговый статус." },
  { num: 2, title: "Проверка статуса", desc: "Timell автоматически проверяет статус в ФНС." },
  { num: 3, title: "Публикация задания", desc: "Вы публикуете задание с требованиями и вознаграждением." },
  { num: 4, title: "Выполнение", desc: "Маркетолог выполняет работу и отправляет результат." },
  { num: 5, title: "Выплата и документы", desc: "Система рассчитывает налоги, проводит платеж, генерирует чек и акт." },
];

const benefits = [
  { icon: TrendingDown, title: "Снижение издержек", desc: "Автоматизация документооборота и выплат снижает нагрузку на бухгалтерию. Обработка за 2 минуты." },
  { icon: Scale, title: "Юридическая безопасность", desc: "Корректное оформление документов по требованиям ФНС. Нет налоговых рисков и штрафов." },
  { icon: AlertTriangle, title: "Минимизация рисков", desc: "Автоматическая проверка статуса защищает от непредвиденных налоговых начислений." },
];

const comparison = [
  { without: "Маркетолог отправляет счёт вручную", withT: "Маркетолог отправляет результат через платформу" },
  ...
  { without: "Время на маркетолога: 30-60 минут", withT: "Время на маркетолога: 2 минуты" },
  { without: "Маркетолог ждёт платёж 3-5 дней", withT: "Маркетолог получает платёж за 1-2 часа" },
  { without: "Риск налоговых проверок: высокий", withT: "Риск налоговых проверок: исключен" },
];
...
const specifics = [
  ...
  { icon: Ban, title: "Функционал «Чёрного списка»", desc: "Добавляйте ненадежных исполнителей в чёрный список для минимизации рисков." },
  { icon: Globe, title: "Иностранные маркетологи", desc: "При сотрудничестве с самозанятым иностранцем нужно уведомить МВД. Timell делает это автоматически." },
  { icon: CreditCard, title: "Выплаты на карту или счёт", desc: "Маркетолог выбирает способ получения: на карту или на расчётный счёт (для ИП)." },
];

const marketerTypes = ["SMM-специалисты", "Контент-менеджеры", "SEO-специалисты", "PPC-менеджеры", "Аналитики", "Дизайнеры", "Видеографы", "BTL-менеджеры"];
const marketerIcons = [Share2, FileEdit, BarChart3, MousePointerClick, LineChart, Palette, Video, Megaphone];
...
const taxStatuses = [
  ...
  { title: "Иностранные граждане", desc: "Поддержка работы с иностранными маркетологами из стран ЕАЭС и СНГ" },
];
...
const speedSteps = [
  { label: "Маркетолог завершает задание", time: "0 минут" },
...
const metrics = [
  ...
  { value: "500 000+", label: "маркетологов на платформе" },
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-extrabold font-display leading-tight text-foreground">
              Выплаты самозанятым{" "}
              <span className="text-primary">маркетологам</span>
            </h1>
          ...
          <div className="hidden lg:flex justify-center">
            <div className="w-72 h-72 rounded-full bg-primary/10 flex items-center justify-center">
              <Megaphone className="w-32 h-32 text-primary/40" />
            </div>
          </div>
        </div>
      </section>
          ...
          <Card className="border-primary/20 bg-accent/20">
            <CardContent className="p-8 text-center space-y-4">
              <p className="text-lg text-foreground leading-relaxed">
                Timell — это платформа для выплат самозанятым маркетологам, BTL-менеджерам, SMM-специалистам и другим маркетинговым профессионалам. Автоматизируем документооборот, проверяем статусы, генерируем чеки и акты.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container">
          <h2 className="text-3xl lg:text-4xl font-bold font-display text-center mb-12">
            Возможности платформы для маркетинговых агентств
          </h2>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="text-3xl lg:text-4xl font-bold font-display text-center mb-16">
            Как работает система выплат для маркетологов
          </h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container">
          <h2 className="text-3xl lg:text-4xl font-bold font-display text-center mb-12">
            Почему это выгодно вашей маркетинговой компании
          </h2>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="text-3xl lg:text-4xl font-bold font-display text-center mb-12">
            Как меняется работа маркетинговой компании
          </h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container">
          <h2 className="text-3xl lg:text-4xl font-bold font-display text-center mb-12">
            Особенности работы с маркетологами на платформе
          </h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container text-center">
          <h2 className="text-3xl lg:text-4xl font-bold font-display mb-4">
            Платформа работает со всеми видами маркетологов
          </h2>
          <p className="text-muted-foreground mb-10 max-w-2xl mx-auto">
            Независимо от специальности, если вы работаете с маркетологами, Timell поможет с выплатами
          </p>
          <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
            {marketerTypes.map((type, i) => {
              const Icon = marketerIcons[i];
              return (
      ...
      <section className="py-16 bg-accent/30">
        <div className="container max-w-4xl text-center space-y-6">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            Электронный документооборот вкупе с удобной системой платежей через загрузочные файлы делают процесс выплат простым и безопасным. Все документы подписываются дистанционно с помощью ЭЦП.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-accent/30">
        <div className="container max-w-4xl text-center space-y-6">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            Timell интегрируется с Asana, Monday.com, Jira, 1С и другими системами через открытый API. Все данные автоматически синхронизируются.
          </p>
      ...
      <section className="py-16">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            {[
              { value: "80%", label: "Экономия времени", desc: "50 маркетологов — это 20-40 часов экономии в месяц." },
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container max-w-3xl text-center">
          ...
          <ConsentCheckbox id="consent-marketer" checked={consentPd} onCheckedChange={setConsentPd} variant="dark" className="mt-4" />
        ...
        <div className="container max-w-5xl">
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Timell — это онлайн-платформа для выплат самозанятым маркетологам и BTL-специалистам с полной автоматизацией документооборота. Снижаем операционные издержки и налоговые риски.
            </p>
          </div>
...
export default MarketerPayments;
